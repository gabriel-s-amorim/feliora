...
export const melhorEnvioSettingsSchema = z.object({
  ...
  userAgent: z
    .string()
    .min(5, "Informe o User-Agent (ex: Feliora (contato@feliora.com.br))")
    .optional(),
...
export type MelhorEnvioSettingsParsed = z.infer<
  typeof melhorEnvioSettingsSchema
>;
...
export const shippingQuoteSchema = z.object({
  toPostalCode: postalCodeSchema.refine(
    (v) => v.length === 8,
    "CEP de destino inválido"
  ),
  products: z
    .array(shippingQuoteProductSchema)
...
export type CheckoutShippingQuoteInput = z.infer<
  typeof checkoutShippingQuoteSchema
>;
