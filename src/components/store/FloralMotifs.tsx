...
/** Rosa peônia — traço fino de tatuagem */
  ...
  return (
    <svg viewBox="0 0 400 480" fill="none" aria-hidden {...props}>
      <g stroke="currentColor" strokeLinecap="round" strokeLinejoin="round">
        ...
        />
        <path strokeWidth="0.9" d="M188 148c4 6 10 10 12 10s8-4 12-10" />
        <path strokeWidth="0.9" d="M176 132c8 2 16-2 24-2s16 4 24 2" />
        <path strokeWidth="0.9" d="M170 158c10-4 20-2 30-2s20-2 30 2" />
        <path
          strokeWidth="1.05"
        ...
        />
        <path strokeWidth="1.05" d="M200 210v78" />
        <path
          strokeWidth="1"
...
export function FloralSpray(props: IconProps) {
  return (
    <svg viewBox="0 0 320 360" fill="none" aria-hidden {...props}>
      <g stroke="currentColor" strokeLinecap="round" strokeLinejoin="round">
        <path strokeWidth="1.05" d="M160 40c-8 22-6 48 4 70" />
        <path
          strokeWidth="1"
        ...
        />
        <circle cx="164" cy="74" r="5" strokeWidth="0.95" />
        <path strokeWidth="0.9" d="M160 150c-4 40-2 80 8 120" />
        <path
          strokeWidth="0.95"
  ...
  return (
    <svg viewBox="0 0 280 420" fill="none" aria-hidden {...props}>
      <g stroke="currentColor" strokeLinecap="round" strokeLinejoin="round">
        ...
        />
        <circle cx="152" cy="252" r="4.5" strokeWidth="0.95" />
        <path
          strokeWidth="0.9"
