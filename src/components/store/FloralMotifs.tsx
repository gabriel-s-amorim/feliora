...
/** Rosa — contorno forte, miolo fino */
  ...
  return (
    <svg viewBox="0 0 400 480" fill="none" aria-hidden {...props}>
      <g stroke="currentColor" strokeLinecap="round" strokeLinejoin="round">
        ...
        />
        <path strokeWidth="0.75" d="M188 148c4 6 10 10 12 10s8-4 12-10" />
        <path strokeWidth="0.75" d="M176 132c8 2 16-2 24-2s16 4 24 2" />
        <path strokeWidth="0.75" d="M170 158c10-4 20-2 30-2s20-2 30 2" />
        <path
          strokeWidth="1.9"
        ...
        />
        <path strokeWidth="2.2" d="M200 210v78" />
        <path
          strokeWidth="1.9"
        ...
        />
        <path strokeWidth="0.65" opacity="0.85" d="M188 236c-6 10-4 22 4 28" />
        <path strokeWidth="0.65" opacity="0.85" d="M212 256c6 10 4 22-4 28" />
      </g>
    </svg>
  );
}

/** Buquê — hastes fortes, detalhes finos */
export function FloralSpray(props: IconProps) {
  return (
    <svg viewBox="0 0 320 360" fill="none" aria-hidden {...props}>
      <g stroke="currentColor" strokeLinecap="round" strokeLinejoin="round">
        <path strokeWidth="2.1" d="M160 40c-8 22-6 48 4 70" />
        <path
          strokeWidth="2"
        ...
        />
        <circle cx="164" cy="74" r="5" strokeWidth="1.7" />
        <path strokeWidth="1.9" d="M160 150c-4 40-2 80 8 120" />
        <path
          strokeWidth="1.8"
        ...
        />
        <circle cx="118" cy="186" r="3.5" strokeWidth="0.85" />
        <path
          strokeWidth="1.8"
        ...
        />
        <circle cx="248" cy="158" r="3.5" strokeWidth="0.85" />
        <path
          strokeWidth="0.7"
  ...
  return (
    <svg viewBox="0 0 280 420" fill="none" aria-hidden {...props}>
      <g stroke="currentColor" strokeLinecap="round" strokeLinejoin="round">
        ...
        />
        <circle cx="152" cy="252" r="4.5" strokeWidth="1.6" />
        <path
          strokeWidth="1.7"
...
/** Flor lateral compacta — para acentos extras */
export function FloralBloom(props: IconProps) {
  return (
    <svg viewBox="0 0 240 280" fill="none" aria-hidden {...props}>
      <g stroke="currentColor" strokeLinecap="round" strokeLinejoin="round">
        <path
          strokeWidth="2.2"
          d="M120 40c-16 10-28 30-28 52 0 28 14 50 28 62 14-12 28-34 28-62 0-22-12-42-28-52z"
        />
        <path
          strokeWidth="1.2"
          d="M120 58c-9 6-15 18-15 30 0 16 6 28 15 36 9-8 15-20 15-36 0-12-6-24-15-30z"
        />
        <path strokeWidth="0.7" d="M108 88c4 5 8 8 12 8s8-3 12-8" />
        <path
          strokeWidth="1.8"
          d="M92 70c-14-16-6-36 12-42 4 12 0 28-12 42z"
        />
        <path
          strokeWidth="1.8"
          d="M148 70c14-16 6-36-12-42-4 12 0 28 12 42z"
        />
        <path
          strokeWidth="1.7"
          d="M86 110c-18-4-28 14-20 30 12 2 24-10 20-30z"
        />
        <path
          strokeWidth="1.7"
          d="M154 110c18-4 28 14 20 30-12 2-24-10-20-30z"
        />
        <path strokeWidth="2" d="M120 154v56" />
        <path
          strokeWidth="1.7"
          d="M120 178c-20-6-32 12-24 28 12 2 20-10 24-28z"
        />
        <path
          strokeWidth="0.75"
          d="M120 198c20-6 32 12 24 28-12 2-20-10-24-28z"
        />
      </g>
    </svg>
  );
