...
/** Rosa — contorno marcado, miolo e detalhes em traço fino */
  ...
  return (
    <svg viewBox="0 0 400 480" fill="none" aria-hidden {...props}>
      <g stroke="currentColor" strokeLinecap="round" strokeLinejoin="round">
        ...
        />
        <path strokeWidth="0.65" d="M188 148c4 6 10 10 12 10s8-4 12-10" />
        <path strokeWidth="0.65" d="M176 132c8 2 16-2 24-2s16 4 24 2" />
        <path strokeWidth="0.65" d="M170 158c10-4 20-2 30-2s20-2 30 2" />
        {/* Pétalas laterais — peso médio */}
        <path
          strokeWidth="1.5"
        ...
        />
        {/* Caule marcado */}
        <path strokeWidth="1.8" d="M200 210v78" />
        {/* Folhas — uma forte, detalhes finos */}
        <path
          strokeWidth="1.55"
        ...
        />
        <path strokeWidth="0.55" opacity="0.8" d="M188 236c-6 10-4 22 4 28" />
        <path strokeWidth="0.55" opacity="0.8" d="M212 256c6 10 4 22-4 28" />
      </g>
    </svg>
  );
}

/** Buquê — hastes fortes, flores com contraste de peso */
export function FloralSpray(props: IconProps) {
  return (
    <svg viewBox="0 0 320 360" fill="none" aria-hidden {...props}>
      <g stroke="currentColor" strokeLinecap="round" strokeLinejoin="round">
        <path strokeWidth="1.7" d="M160 40c-8 22-6 48 4 70" />
        <path
          strokeWidth="1.6"
        ...
        />
        <circle cx="164" cy="74" r="5" strokeWidth="1.4" />
        <path strokeWidth="1.5" d="M160 150c-4 40-2 80 8 120" />
        <path
          strokeWidth="1.45"
        ...
        />
        <circle cx="118" cy="186" r="3.5" strokeWidth="0.7" />
        <path
          strokeWidth="1.45"
        ...
        />
        <circle cx="248" cy="158" r="3.5" strokeWidth="0.7" />
        <path
          strokeWidth="0.6"
...
/** Videira — caule forte, folhas e flor com pesos mistos */
  ...
  return (
    <svg viewBox="0 0 280 420" fill="none" aria-hidden {...props}>
      <g stroke="currentColor" strokeLinecap="round" strokeLinejoin="round">
        ...
        />
        {/* Flor — pétalas fortes + miolo fino */}
        <path
          strokeWidth="1.55"
        ...
        />
        <circle cx="152" cy="252" r="4.5" strokeWidth="1.3" />
        <path
          strokeWidth="1.35"
